    ...
    <body>
        ...
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="" class="nav__logo">Cartopia</a>
                </div>

                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                    	<% if(session.getAttribute("name")==null) {%>
                    	 <li class="nav__item"><a href="logout.jsp" class="nav__link">Guest</a></li>
                         ...
                         <% if(session.getAttribute("name") != null && session.getAttribute("name").equals("admin")) { %>
    							<li class="nav__item"><a href="admin.jsp" class="nav__link">Admin-dashboard</a></li>
							<% } %>

                         <li class="nav__item"><a href="logout.jsp" class="nav__link"><%=session.getAttribute("name") %></a></li>
                         <li class="nav__item"><a href="logout.jsp" class="nav__link">Log out</a></li>
                         <%}%>
                        <li class="nav__item"><a href="#home" class="nav__link active">Home</a></li>
                        <li class="nav__item"><a href="product.jsp" class="nav__link">Products</a></li>
            ...
            <section class="home" id="home">
                <div class="home__container bd-grid">
                    <div class="home__data">
                        ...
                        <a href="product.jsp" class="button">GO SHOPPING</a>
                    </div>
